...
To build the final jar and optimize the UGDTCustomerFeedbackApp application for production, run:
...
Then navigate to [http://localhost:9014](http://localhost:9014) in your browser.
