package ug.co.absa.customer.feedback.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.customer.feedback.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.customer.feedback.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ug.co.absa.customer.feedback.service.InvalidPasswordException
